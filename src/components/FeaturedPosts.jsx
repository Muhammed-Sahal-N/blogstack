  ...
  return (
    <div className="mt-8 flex flex-col lg:flex-row gap-8">
        ...
        <div className="w-full lg:w-1/2 flex flex-col gap-4">
            {/* image */}
            {posts[0].img && <Image src={posts[0].img}  className="rounded-3xl object-cover"
          w="895" />}
          ...
          {/* title */}
          <Link to={posts[0].slug}  className="text-base sm:text-lg md:text-2xl lg:text-xl xl:text-2xl font-medium">
          {posts[0].title} 
        ...
        <div className="w-full lg:w-1/2 flex flex-col gap-4">
            ...
            {posts[1] &&<div className="lg:h-1/3 flex justify-between gap-4">
               ...
               <Image src={posts[1].img}  className="rounded-3xl object-cover w-full h-full"
              w="298"/>
               </div>}
              {/* details and title */}
              <div className="w-2/3">
              ...
              <span className="text-gray-500 text-sm">{format(posts[1].createdAt)}</span>
                ...
                {/* title */}
                <Link to={posts[1].slug} className="text-base sm:text-lg md:text-2xl lg:text-xl xl:text-2xl font-medium">{posts[1].title}
                </Link>
            ...
            {posts[2].img &&<div className="w-1/3 aspect-video">
              ...
              <span className="text-gray-500 text-sm">{format(posts[2].createdAt)}</span>
                ...
                {/* title */}
                <Link to={posts[1].slug} className="text-base sm:text-lg md:text-2xl lg:text-xl xl:text-2xl font-medium"> {posts[2].title}
                </Link>
            ...
            {posts[3].img &&<div className="w-1/3 aspect-video">
               <Image src={posts[3].img}  className="rounded-3xl object-cover w-full h-full"
              w="298"/>
               </div>}
              {/* details and title */}
              <div className="w-2/3">
              ...
              <span className="text-gray-500 text-sm">{format(posts[3].createdAt)}</span>
                ...
                {/* title */}
                <Link to={posts[3].slug} className="text-base sm:text-lg md:text-2xl lg:text-xl xl:text-2xl font-medium">{posts[3].title}
                </Link>
